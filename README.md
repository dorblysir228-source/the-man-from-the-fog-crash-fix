...
### 📥 Как установить:
1. Перейдите во вкладку [Releases]([https://github.com](https://github.com/dorblysir228-source/the-man-from-the-fog-crash-fix/releases)) справа.
...
### 📥 How to install:
1. Go to the [Releases]([https://github.com](https://github.com/dorblysir228-source/the-man-from-the-fog-crash-fix/releases)) section on the right.
